...
void solve(){
	int blx1,bly1,trx1,try1;
	int blx2,bly2,trx2,try2;
	int blx3,bly3,trx3,try3;
	int a1,a2,i1,i2,t1,t2;
	a1 = (try1 - bly1)*(trx1-blx1);
	a2 = (try2 - bly2)*(trx2-blx2);
	i1 = (blx3-trx1)*(try1-bly3);
